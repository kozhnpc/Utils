...
public class NotificationUtils {
     ...
     */
    public static void notify(int id, Func1<Void, NotificationCompat.Builder> func1) {
     ...
     * @param func1 The function of create the builder of notification.
     */
    public static void notify(String tag, int id, Func1<Void, NotificationCompat.Builder> func1) {
     ...
     * @param func1         The function of create the builder of notification.
     */
    public static void notify(int id, ChannelConfig channelConfig, Func1<Void, NotificationCompat.Builder> func1) {
     ...
     * @param func1         The function of create the builder of notification.
     */
    public static void notify(String tag, int id, ChannelConfig channelConfig, Func1<Void, NotificationCompat.Builder> func1) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationManager nm = (NotificationManager) UIUtils.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
            nm.createNotificationChannel(channelConfig.getNotificationChannel());
        }

        NotificationManagerCompat nmc = NotificationManagerCompat.from(UIUtils.getContext());
    ...
    public static void cancel(String tag, final int id) {
        NotificationManagerCompat.from(UIUtils.getContext()).cancel(tag, id);
    }
    ...
    public static void cancel(final int id) {
        NotificationManagerCompat.from(UIUtils.getContext()).cancel(id);
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = UIUtils.getContext().getSystemService("statusbar");
    ...
    public static class ChannelConfig {
        ...
        public static final ChannelConfig DEFAULT_CHANNEL_CONFIG = new ChannelConfig(
                UIUtils.getContext().getPackageName(), UIUtils.getContext().getPackageName(), IMPORTANCE_DEFAULT
        );
