...
public class RomUtil {
    ...
    public static double getEmuiVersion() {
        try {
            String emuiVersion = getSystemProperty1("ro.build.version.emui");
    ...
    public static int getMiuiVersion() {
        String version = getSystemProperty1("ro.miui.ui.version.name");
        if (version != null) {
            try {
    ...
    public static String getSystemProperty1(String propName) {
        String line;
    ...
    public static boolean checkIsMiuiRom() {
        return !TextUtils.isEmpty(getSystemProperty1("ro.miui.ui.version.name"));
    }

    public static boolean checkIsMeizuRom() {
        //return Build.MANUFACTURER.contains("Meizu");
        String meizuFlymeOSFlag = getSystemProperty1("ro.build.display.id");
